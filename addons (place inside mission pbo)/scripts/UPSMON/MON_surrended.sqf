...

{
	if ( leader _x == _x ) then {
		_x addaction ["Order your men to follow me", "addons\scripts\UPSMON\actions\followme.sqf", [], 1, false];
	} else {
		_x addaction ["Follow me", "addons\scripts\UPSMON\actions\followme.sqf", [], 1, false];
	};
}forEach _soldiers;

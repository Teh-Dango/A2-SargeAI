/* =====================================================================================================
 ...
 =====================================================================================================
	Parámeters: [Param1,Param2,Param3,[Param4]]  EXECVM "addons\scripts\UPSMON\MON_SPAWN.SQF";	
  ...
  =====================================================================================================
	...
	2- Exec MON_spawn on trigger or where you want telling the copy of the template to create
		and the position.
		nul = [1,[0,0,0],3,[mark, upsmon optional params]] EXECVM "addons\scripts\UPSMON\MON_SPAWN.SQF";		
 =====================================================================================================*/
